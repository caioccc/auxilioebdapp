...
const plans: Plan[] = [
  {
    ...
    highlight: false,
    waMsg:
      "Olá! Quero adquirir o plano Trimestral da Mentoria RHEMA por R$ 45,00.",
  },
  {
    planId: "anual",
    title: "Anual",
  ...
  },
  {
    ...
    highlight: false,
    waMsg:
      "Olá! Quero adquirir o plano Completo Trimestral (Adultos + Jovens) por R$ 65,00.",
  },
  {
    ...
    highlight: false,
    waMsg:
      "Olá! Quero adquirir o plano Completo Anual (Adultos + Jovens) por R$ 179,00.",
  },
];
  ...
  return (
    <>
      <Helmet>
        ...
        <meta
          property="og:title"
          content="Mentoria RHEMA — Transforme suas aulas da EBD"
        />
        <meta
      ...
      <FaqSchema
        items={faqData.map(({ q, a }) => ({ question: q, answer: a }))}
      />
      <OrganizationSchema />
            ...
            <Flex align="center" justify="space-between" h="100%">
              ...
              <Group gap="xl" visibleFrom="md">
                ...
                <Button
                  component="a"
                  href={waLink(
                    "Olá! Gostaria de saber mais sobre a Mentoria RHEMA.",
                  )}
                  target="_blank"
                  ...
                  <Stack gap="xl">
                    ...
                    <motion.div variants={fadeUp}>
                      <Text fz="md" c="gray.6" lh={1.75} maw={520}>
                        Descubra a Mentoria RHEMA: a ferramenta completa com
                        profundidade exegética, subsídios prontos e orientação
                        prática para professores das revistas CPAD (Adultos e
                        Jovens).
                      </Text>
                    </motion.div>
                    ...
                    <motion.div variants={fadeUp}>
                      <Group gap="md" wrap="wrap">
                        <Button
                          component="a"
                          href={waLink(
                            "Olá! Quero transformar minhas aulas da EBD com a Mentoria RHEMA!",
                          )}
                          target="_blank"
                          rel="noopener noreferrer"
                          color="orange.6"
                          ...
                          style={{
                            boxShadow: "0 4px 24px rgba(234,88,12,0.25)",
                          }}
                        >
                ...
                <Stack gap="xl" align="center" ta="center">
                  ...
                  <motion.div variants={fadeUp}>
                    <Text c="gray.6" fz="md" lh={1.8} maw={620}>
                      Ser um professor de Escola Bíblica Dominical é algo
                      glorioso — mas a realidade do dia a dia pode ser pesada:
                      semana corrida, pouco tempo para estudar, material escasso
                      e a sensação de que ninguém valoriza o esforço. O
                      resultado é o mais doloroso: a sala vazia e alunos
                ...
                <motion.div variants={fadeUp}>
                  ...
                  >
                    <Text fz="lg" c="blue.9" lh={1.8} fw={500} fs="italic">
                      "Eu entendo. Ensino na EBD há 30 anos e já passei por tudo
                      isso. A grande maioria dos professores são voluntários
                      movidos pelo amor a Deus e às pessoas — não por obrigação.
                      Eles merecem suporte de verdade, não mais cobranças."
                    </Text>
                ...
                <Stack gap="xl" align="center" ta="center" mb={56}>
                  ...
                  <motion.div variants={fadeUp}>
                    <Text c="gray.6" fz="md" maw={560} lh={1.8}>
                      ...
                      para transformar cada domingo em uma experiência de ensino
                      que marca vidas. Chega de aulas sem qualidade, sala vazia
                ...
                <Stack gap="xl" align="center" ta="center" mb={56}>
                  ...
                  <motion.div variants={fadeUp}>
                    <Title
                      ...
                      style={{ letterSpacing: "-0.02em" }}
                    >
                      Quanto vale preparar suas aulas com segurança,
                      profundidade e economizar horas de estudo todas as
                      semanas?
                    </Title>
                  </motion.div>
                </Stack>
                        ...
                        <Stack gap="md" mt={plan.highlight ? 8 : 0}>
                          ...
                          <SimpleGrid cols={2} spacing={8}>
                            ...
                            <Image
                              ...
                              radius="md"
                              style={{
                                opacity: plan.title.includes("Completo")
                                  ? 0.85
                                  : 0.3,
                          ...
                          <Group gap={4} align="flex-end">
                            <Text
                              fz={36}
                              fw={800}
                              c={plan.highlight ? "orange.6" : "blue.9"}
                              lh={1}
                            >
                              {plan.price}
                            </Text>
              ...
              >
                <Stack gap="xl" align="center" ta="center">
                  ...
                  <Text fz="lg" c="blue.2" maw={520} lh={1.8}>
                    Junte-se aos professores que preparam suas aulas com
                    confiança, profundidade e alegria — domingo após domingo.
                  </Text>
                  <Button
                    component="a"
                    href={waLink(
                      "Olá! Quero começar agora com a Mentoria RHEMA!",
                    )}
                    target="_blank"
                    rel="noopener noreferrer"
                    color="orange.5"
            ...
            <Container size="xl">
              ...
              >
                ...
                <Group gap="xl">
                  ...
                  <Anchor
                    href={waLink(
                      "Olá! Quero entrar em contato com a Mentoria RHEMA.",
                    )}
                    target="_blank"
                    rel="noopener noreferrer"
                    c="blue.3"
